...
const LANDING_STYLES = `
    ...
    @media (max-width: 350px) {
        .hero-title {
            font-size: clamp(1.8rem, 12vw, 2.4rem) !important;
                ...
                <section className="hero-section" style={{
                    ...
                    <div className="container" style={{ position: 'relative', zIndex: 2 }}>
                        ...
                        <p className="animate-fade-in hero-subtitle" style={{
                            ...
                            {t('landing.hero.subtitle').split(/(<1>.*?<\/1>|<2>.*?<\/2>)/g).map((part, i) => {
                                if (part.startsWith('<1>')) {
                                    ...
                                    return (
                                        <span key={i} style={{
                                            ...
                                            <svg width="1.2em" height="1.2em" viewBox="0 0 24 24" fill="currentColor" style={{ verticalAlign: '-0.2em', marginRight: '0.45rem' }}>
